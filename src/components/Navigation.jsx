  ...
  return (
    <>
      ...
      <nav className="hidden md:flex fixed top-10 left-1/2 -translate-x-1/2 z-50">
        <div className="flex items-center gap-10 px-12 py-4 rounded-full border-2 border-gray-900 bg-white/80 backdrop-blur-md">
      ...
      {!menuOpen && (
        <button
          ...
          className="md:hidden fixed top-6 right-6 z-50 w-12 h-12 rounded-full border-2 border-gray-900 bg-white/80 backdrop-blur-md flex items-center justify-center"
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-40">
          ...
          <div className="relative z-50 h-full flex flex-col items-center justify-center gap-10">
            ...
            <button
              onClick={() => setMenuOpen(false)}
              className="absolute top-6 right-6 text-3xl font-bold z-50"
