...
const CertificationCard = ({ certification }) => {
  ...
  return (
    <div className="bg-white dark:bg-[rgb(15,15,15)] rounded-2xl overflow-hidden border border-gray-200 dark:border-white shadow-sm hover:shadow-xl transition-all duration-500 group h-full flex flex-col">
      {/* IMAGEN DEL CERTIFICADO */}
      <div className="h-48 relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-black flex-shrink-0 cursor-pointer" onClick={openImageInNewWindow}>
        {hasImage ? (
          <>
            <img
      ...
      <div className="p-6 flex-grow flex flex-col">
        ...
        <div className="mb-6 flex-grow space-y-3">
          <div className="flex items-start">
            <svg className="w-5 h-5 text-gray-600 dark:text-gray-300 mt-0.5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
